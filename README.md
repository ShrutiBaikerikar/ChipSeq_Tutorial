...
Analysing the DNA sequences underlying peak regions or motifs provides insights into the DNA binding preference of the proteins.
...
- Word-based: all possible k-mers or sequences of length k are exhaustively enumerated to generate consensus motifs that occur with increased frequency 
...
It contains many useful tools for analyzing ChIP-Seq, RNA-Seq, Hi-C and numerous other types of functional genomics sequencing data sets.
